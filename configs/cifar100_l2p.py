...
def get_args_parser(subparsers):
    subparsers.add_argument("--cuda", type=int, default=5,
    ...
    subparsers.add_argument('--set_training_node', default=True, help='Load pretrained model or not')
    ...
    subparsers.add_argument('--device', default='cuda:6', help='device to use for training / testing')
