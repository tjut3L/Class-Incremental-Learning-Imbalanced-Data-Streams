...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument("--cuda", type=int, default=0,
                            help="Select zero-indexed cuda device. -1 to use CPU.")
    subparsers.add_argument("--config_file", type=str, default="config_s1.pkl")
    subparsers.add_argument("--log_file", type=str, default='./log_.txt')
    subparsers.add_argument("--run_name", type=str, default="test_s1")
    subparsers.add_argument("--nb_classes", type=int, default=100)
    #
    # Model parameters
    ...
    subparsers.add_argument('--set_training_mode', default=True, help='Load pretrained model or not')
    ...
    subparsers.add_argument('--num_tasks', default=50, type=int, help='number of sequential tasks')
    ...
    # subparsers.add_argument('--size', default=50, type=int, )
    subparsers.add_argument('--size', default=50, type=int, )
