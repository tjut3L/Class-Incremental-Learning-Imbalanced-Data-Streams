...
with open("/home/HDD2/jskj_taozhe/Cars/train.txt",'r') as f:
    q = f.readlines()
    for k in q:
        p = k.split(' ')
        data_split[int(p[1])].append(int(p[0][8:14]))




p_fir = 0.2  #0.5 0.2 0.02
num_samples_per_task = 4000
