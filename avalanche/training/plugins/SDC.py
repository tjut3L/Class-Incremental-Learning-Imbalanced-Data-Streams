...
class SDCPlugin(SupervisedPlugin):
    """
    ...
    def before_training_exp(
        ...
        old_class_in_curr_exp = \
        strategy.benchmark.present_classes_in_each_exp[strategy.experience.current_experience].shape[
            0] - new_class_in_curr_exp
    ...
    def compute_loss(self, strategy):
        ...
        for i in range(len(self.protos)):
            ...
            loss_protoaug += nn.CrossEntropyLoss()(soft_feat,
                                                   torch.tensor(self.proto_labels[i]).to(strategy.device))  # alpha *
