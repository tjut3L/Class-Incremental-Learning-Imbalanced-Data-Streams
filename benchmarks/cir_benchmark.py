...
def class_subset(train_set, indices):
...
def generate_benchmark(
    ...
    'n_sample/s_table', 100*50  每一类数据出现的示例个数
     'n_classes',  类总数
     'n_e',        任务数
    ...
    def create_dataset_exp_i(exp_i):
        ...
        ds_i = classification_subset(train_set, indices=all_indices_i)  # class_subset 函数
        # 从 train set 中取出indices为all_indices_i的data
    ...
    benchmark.num_seen_class = {}
    benchmark.classifier = 'fc'
    return benchmark
