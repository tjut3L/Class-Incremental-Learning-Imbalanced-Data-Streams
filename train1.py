...
from avalanche.training.plugins import EWCPlugin, LwFPlugin, ReplayPlugin,DKDPlugin,BiCPlugin,MIRPlugin,PASSPlugin,CoPEPlugin,SDCPlugin
...
def main(args):
    ...
    benchmark = get_cifar_based_benchmark(scenario_config=args.config_file,
                                          seed=args.seed)
    # --- Model
    model = SlimResNet18(benchmark.n_classes*4)
    ...
    cl_strategy = Naive(
        ...
        CrossEntropyLoss(),
        train_mb_size=16,
        train_epochs=40,  # if args.config_file == "config_s2.pkl" else 60,
        eval_mb_size=100,
        device=device,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_file", type=str, default="cub_200_2.pkl")
